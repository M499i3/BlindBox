...
ORDER_SPECS: list[tuple[str, str, str, str]] = [
    ...
    ("user4@test.com", "user1@test.com", "2141", "pending"),
    ("user5@test.com", "user1@test.com", "2142", "pending"),
    ...
    ("user5@test.com", "user2@test.com", "2135", "pending"),
    ("user1@test.com", "user3@test.com", "2132", "completed"),
    ("user2@test.com", "user3@test.com", "2131", "shipped"),
    ("user4@test.com", "user3@test.com", "2129", "pending"),
    ("user5@test.com", "user3@test.com", "2133", "pending"),
    ("user1@test.com", "user4@test.com", "2134", "completed"),
    ("user2@test.com", "user4@test.com", "2130", "pending"),
